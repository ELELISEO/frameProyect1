...
const EliminiarTAlmacen = ({ isOpen, onClose, clearInput}) => {
  const [idEliminar, setIdEliminar] = useState("")
    ...
    const handleEliminar = async () => {
      ...
      const id = parseInt(idEliminar, 10)
        const response = await fetch(`http://localhost:5000/almacen/almacen/deleteId/${id}`, {
...
export default EliminiarTAlmacen