        ...
        <section className='h-full w-full flex'>
          <div className='bg-white h-full w-1/2 flex flex-col justify-between border-r-color6 border-r-2'> {/*DIV IZQUIERDA*/}
            ...
            <div className='h-auto w-full flex flex-col'> {/*DIV MAYOR*/}
              <div className='flex'>
                <div className='bg-white h-12 w-96 text-color1 text-left font-bold pl-8 text-xl border-color6 border-t-2'> {/*DIV  TOTAL*/}
                  TOTAL
                </div>
                <div className='bg-white h-12 w-96  text-color1 text-left font-bold pl-8 text-xl  border-color6 border-t-2 border-l-2'> {/*DIV COBRO*/}
                  COBRO
                </div>
              </div>
              <div>

                <div className='bg-white h-12 w-full text-color1 text-left font-bold pl-8 text-xl border-color6 border-t-2'> {/*DIV CAMBIO*/}
                  CAMBIO
                </div>
              </div>
